...
def _build_chat_leave_form(leave_types: list, error: str = "", prefill: dict = None) -> dict:
    ...
    body = [
        ...
        {"type": "Input.Date", "id": "from_date", "label": "From Date", "isRequired": True, "value": prefill.get("from_date") or ""},
        {"type": "Input.Date", "id": "to_date",   "label": "To Date",   "isRequired": True, "value": prefill.get("to_date") or ""},
        {
            "type": "Input.Text",
            "id": "reason",
            "label": "Reason",
